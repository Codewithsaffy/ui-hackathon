  ...
  if (cartCount === 0) {
    return (
      <main>
        ...
        <section className="container mt-20 mx-auto md:p-0 px-4 py-8">
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-[#1D3178]">
              Your cart is empty
            </h2>
            <p className="text-[#A1A8C1] mt-4">
              ...
              >
                ...
                <div className="col-span-6 relative flex gap-4 items-center">
                  ...
                  <button
                    ...
                    className="absolute top-0 left-0 bg-black leading-none text-white w-3 h-3 md:w-5 md:h-5 rounded-full flex justify-center items-center"
                  >
                    x
                  </button>
                  <div>
